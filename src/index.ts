...
app.get("/", (_req: Request, res: Response) => {
  res.json({
    ...
    docs: "Grupos: /groups/*, jogos, ranking, scouts. Admin (JWT ADMIN): /admin/users, /admin/groups, /admin/legal-documents, /admin/scout-metrics, moderação de contas. Auth: /auth/login (atleta), /auth/admin-login (ADMIN, e-mail — front em /admin/login), /auth/me.",
  });
});
